...
class __TwigTemplate_5fc3c0c77d34fcb7dcd374e30f81c282d5a1df8e4d01b0e98ff78b32688ccbd1 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"panel-body\">
        ...
        echo "              </select>
          ...
          <div class=\"form-group\">
            <label class=\"col-sm-2 control-label\" for=\"input-status\">";
        // line 85
        echo ($context["entry_force_discounts_check"] ?? null);
        echo "</label>
            <div class=\"col-sm-10\">
              <select name=\"payment_paykeeper_force_discounts_check\" id=\"input-status\" class=\"form-control\">
                ";
        // line 88
        if (($context["payment_paykeeper_force_discounts_check"] ?? null)) {
            // line 89
            echo "                <option value=\"1\" selected=\"selected\">";
            echo ($context["text_enabled"] ?? null);
            echo "</option>
        ...
        echo "              </select>
            ...
            <br><i>";
        // line 98
        echo ($context["entry_force_discounts_check_description"] ?? null);
        echo "</i>
            </div>
          </div>
        </form>
